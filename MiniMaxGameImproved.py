...
# The brain of the AI.
def minimaxGameImproved(boardString, depth, isMaximizingPlayer):
    ...
    if isMaximizingPlayer:
        ...
        for move in possible_moves:
            eval_score, _ = minimaxGameImproved(move, depth - 1, False)
        ...
        for move in possible_moves:            
            ...
            eval_score, _ = minimaxGameImproved(move, depth-1, True)
...
def main():
    ...
    eval_score, best_move = minimaxGameImproved(m.board_to_string(initial_board), depth, True)
