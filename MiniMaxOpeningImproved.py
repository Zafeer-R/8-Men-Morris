...
# The brain of the AI.
def minimaxOpeningImproved(boardString, depth, isMaximizingPlayer):
    ...
    if isMaximizingPlayer:
        ...
        for move in possible_moves:
            eval_score, _ = minimaxOpeningImproved(move, depth - 1, False)
        ...
        for move in possible_moves:            
            ...
            eval_score, _ = minimaxOpeningImproved(move, depth-1, True)
...
def main():
    ...
    eval_score, best_move = minimaxOpeningImproved(m.board_to_string(initial_board), depth, True)
