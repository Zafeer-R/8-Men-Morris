...
# The brain of the AI.
def minimaxMidGameEndGameBlack(boardString, depth, isMaximizingPlayer):
    global positionsEvaluated

    if depth == 0:
        positionsEvaluated += 1
        return m.BetterStaticEstimate(boardString, True), None
    ...
    if isMaximizingPlayer:
        ...
        for move in possible_moves:
            ...
            eval_score, _ = minimaxMidGameEndGameBlack(move, depth - 1, False)
        ...
        for move in possible_moves:            
            eval_score, _ = minimaxMidGameEndGameBlack(move, depth-1, True)
...
def main():
    ...
    if len(sys.argv) == 4:
        ...
        # Default values
        input_file = r"D:/AI/Project_0/board2.txt"
        output_file = r"D:/AI/Project_0/board1.txt"
        depth = 2
    ...
    eval_score, best_move = minimaxMidGameEndGameBlack(m.board_to_string(initial_board), depth, True)
