...
# The brain of the AI.
def minimaxOpeningBlack(boardString, depth, isMaximizingPlayer):
    ...
    if isMaximizingPlayer:
        ...
        for move in possible_moves:
            ...
            eval_score, _ = minimaxOpeningBlack(move, depth - 1, False)
        ...
        # Generate all possible moves for white by flipping the board
        possible_moves = m.GenerateAdd(boardString)        

        for move in possible_moves:                       
            eval_score, _ = minimaxOpeningBlack(move, depth-1, True)
...
def main():
    ...
    eval_score, best_move = minimaxOpeningBlack(m.board_to_string(initial_board), depth, True)
