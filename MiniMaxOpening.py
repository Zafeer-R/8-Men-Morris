...
# The brain of the AI.
def minimaxOpening(boardString, depth, isMaximizingPlayer):
    ...
    if isMaximizingPlayer:
        ...
        for move in possible_moves:
            eval_score, _ = minimaxOpening(move, depth - 1, False)
        ...
        for move in possible_moves:            
            ...
            eval_score, _ = minimaxOpening(move, depth-1, True)
...
def main():
    ...
    eval_score, best_move = minimaxOpening(m.board_to_string(initial_board), depth, True)
